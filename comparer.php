...
<body id="background-destination">
    ...
    <div class="row d-flex justify-content-around aligne-items-center px-5">

        <?php foreach ($locs as $loc) { ?>
            <div class="col-3 card bg-dark m-3" style="width: 18rem;">
                <div class=" logoAgence p-0 ">
                    <img class="imgLogo mt-3" src="images/<?php echo $loc['location'] ?>.jpg" class="card-img-top" alt="...">
                </div>
                ...
                <div class="card-body ">
                    ...
                    <div class="comments-container bg-success p-2 text-dark bg-opacity-10" style="max-height: 200px; overflow-y: auto;">
